...
#### [v2.0.3](https://github.com/kinde-oss/kinde-node-express/compare/v2.0.2...v2.0.3)

- [Snyk] Security upgrade qs from 6.15.3 to 6.16.0 [`#213`](https://github.com/kinde-oss/kinde-node-express/pull/213)
- chore(deps): update dependency lint-staged to v17.3.0 [`#210`](https://github.com/kinde-oss/kinde-node-express/pull/210)
- chore(deps): update dependency globals to v17.11.0 [`#209`](https://github.com/kinde-oss/kinde-node-express/pull/209)
- chore(deps): update vitest monorepo to v4.1.11 [`#207`](https://github.com/kinde-oss/kinde-node-express/pull/207)
- chore(deps): update dependency rollup to v4.62.5 [`#206`](https://github.com/kinde-oss/kinde-node-express/pull/206)
- chore(deps): update dependency prettier to v3.9.6 [`#205`](https://github.com/kinde-oss/kinde-node-express/pull/205)
- chore(deps): update dependency @tsconfig/node24 to v24.0.5 [`#204`](https://github.com/kinde-oss/kinde-node-express/pull/204)
- chore(deps): update dependency @kinde-oss/kinde-typescript-sdk to v2.15.1 [`#203`](https://github.com/kinde-oss/kinde-node-express/pull/203)
- chore(ci): bump Node.js to 24.x [`#164`](https://github.com/kinde-oss/kinde-node-express/pull/164)
- chore: release v2.0.2 [`#201`](https://github.com/kinde-oss/kinde-node-express/pull/201)
- chore(deps): update dependency lint-staged to v17.2.0 [`#200`](https://github.com/kinde-oss/kinde-node-express/pull/200)
- chore: enforce dependency release-age cooldown [`#202`](https://github.com/kinde-oss/kinde-node-express/pull/202)
- Merge pull request #212 from kinde-oss/renovate/typescript-eslint-monorepo [`66ab56e`](https://github.com/kinde-oss/kinde-node-express/commit/66ab56e6805a4cf1b82fb739d89a01bf68d983ed)
- chore(deps): update typescript-eslint monorepo to v8.68.0 [`dc0609a`](https://github.com/kinde-oss/kinde-node-express/commit/dc0609a95e52485af8ef9358dd4197042b4c9fa3)
- Merge pull request #211 from kinde-oss/renovate/vite-8.x-lockfile [`757e50c`](https://github.com/kinde-oss/kinde-node-express/commit/757e50cc8262d59285633ae4326cb15e498d3e9a)

#### [v2.0.2](https://github.com/kinde-oss/kinde-node-express/compare/v2.0.1...v2.0.2)

> 25 July 2026

- chore(deps): update dependency @kinde/jwt-validator to v0.4.4 [`#199`](https://github.com/kinde-oss/kinde-node-express/pull/199)
- chore: release v2.0.1 [`#179`](https://github.com/kinde-oss/kinde-node-express/pull/179)
- chore(deps): update typescript-eslint monorepo to v8.64.0 [`#193`](https://github.com/kinde-oss/kinde-node-express/pull/193)
- chore(deps): update dependency lint-staged to v17.0.8 [`#183`](https://github.com/kinde-oss/kinde-node-express/pull/183)
- chore(deps): update dependency vite to v8.1.5 [`#192`](https://github.com/kinde-oss/kinde-node-express/pull/192)
- chore(deps): update dependency @eslint/eslintrc to v3.3.6 [`#180`](https://github.com/kinde-oss/kinde-node-express/pull/180)
- chore(deps): update dependency @types/supertest to v7.2.1 [`#182`](https://github.com/kinde-oss/kinde-node-express/pull/182)
- chore(deps): update dependency qs to v6.15.3 [`#184`](https://github.com/kinde-oss/kinde-node-express/pull/184)
- chore(deps): update dependency @types/node to v24.13.3 [`#181`](https://github.com/kinde-oss/kinde-node-express/pull/181)
- chore(deps): update dependency @kinde-oss/kinde-typescript-sdk to v2.15.0 [`#187`](https://github.com/kinde-oss/kinde-node-express/pull/187)
- chore(deps): update vitest monorepo to v4.1.10 [`#186`](https://github.com/kinde-oss/kinde-node-express/pull/186)
- chore(deps): update dependency vite-plugin-dts to v5.0.3 [`#185`](https://github.com/kinde-oss/kinde-node-express/pull/185)
- chore(deps): update dependency eslint to v10.7.0 [`#188`](https://github.com/kinde-oss/kinde-node-express/pull/188)
- chore(deps): update actions/setup-node action to v7 [`#196`](https://github.com/kinde-oss/kinde-node-express/pull/196)
- chore(deps): update codecov/codecov-action action to v7 [`#197`](https://github.com/kinde-oss/kinde-node-express/pull/197)
- chore(deps): update actions/checkout action to v7 [`#195`](https://github.com/kinde-oss/kinde-node-express/pull/195)
- chore(deps): update actions/cache action to v6 [`#194`](https://github.com/kinde-oss/kinde-node-express/pull/194)
- fix: resolve pnpm lockfile conflict [`8661332`](https://github.com/kinde-oss/kinde-node-express/commit/8661332c15c3a35e2618153c0640ad7eb7213a4e)
- Merge pull request #189 from kinde-oss/renovate/globals-17.x-lockfile [`e8d6db5`](https://github.com/kinde-oss/kinde-node-express/commit/e8d6db584b27ab3242c32331656b94c41e87029d)
- Merge pull request #190 from kinde-oss/renovate/prettier-3.x-lockfile [`c337beb`](https://github.com/kinde-oss/kinde-node-express/commit/c337bebc6468330c952beaf079600d285d8b52c7)
